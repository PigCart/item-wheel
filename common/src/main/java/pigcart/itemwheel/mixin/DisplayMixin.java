...
public abstract class DisplayMixin implements DisplayAccess {
    ...
    @Shadow protected abstract void setInterpolationDuration(int i);

    @Shadow protected abstract void setInterpolationDelay(int i);
    ...
    public void itemWheel_update(float spinPercent) {
        ...
        this.setInterpolationDuration(ItemWheel.updateFrequency);
